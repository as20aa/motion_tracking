...
void uart2_init(u32 bound){
  ...
  //Usart2 NVIC 配置
  NVIC2_InitStructure.NVIC_IRQChannel = USART2_IRQn;
   ...
   //USART 初始化设置
	...
	USART2_InitStructure.USART_BaudRate = bound/2;//串口波特率
...
void uart3_init(u32 bound){
  ...
  //Usart2 NVIC 配置
  NVIC3_InitStructure.NVIC_IRQChannel = USART3_IRQn;
   ...
   //USART 初始化设置
	...
	USART3_InitStructure.USART_BaudRate = bound/2;//串口波特率
